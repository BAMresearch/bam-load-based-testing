...
while True:
    ...
    m_flow = 720/3600 #in kg/s  #TODO Connect your test bench here!
    t_ret_test_bench = 45 #TODO Connect your test bench here!
    #Calculate time step in Building model
    BamBuilding.doStep(t_sup=t_sup_test_bench, m_dot=m_flow, stepSize=stepSize, t_ret_mea=t_ret_test_bench)
