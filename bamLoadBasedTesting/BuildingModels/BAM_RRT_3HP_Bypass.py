from twoMassModel import CalcParameters, BypassValve
...
ParaMTBui_E = CalcParameters(t_a_design=t_a_design, t_a=-10, q_design=q_design_e, PLC=1, tau_b=tau_b, tau_h=tau_h,
                             t_flow_design=t_flow_design, t_flow_plc=55, t_b=t_b, const_flow=False, mass_flow=mass_flow,
                             boostHeat=True, maxPowBooHea=7000, virtualBypass=True) # booster heater is active! # todo check
